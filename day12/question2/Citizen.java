...
class Demo{
	...
	public static void main(String[] args) {
		...
		c.setName(aadhar);
		System.out.println("=================");
		boolean s=d.validate(c.getName(),c.getMobileNumber(), c.getAadharNumber());
		if(s) {
			System.out.println("Your Name "+c.getName());
	        System.out.println("Your Aadhar No "+c.getAadharNumber());
	        System.out.println("Your Mobile No "+c.getMobileNumber());
		}else {
